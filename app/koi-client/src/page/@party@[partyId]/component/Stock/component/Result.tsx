...
const Result = ({ stockId }: Props) => {
  ...
  const animalDescription =
    animal === 'hamster'
      ? '겉보기와 달리 대담하고 당돌한 매력의 소유자예요. 때로는 장난스럽게 속이고 때로는 예측불가한 행동으로 게임의 재미를 한층 더해주는 빌런이에요!'
      : animal === 'rabbit'
      ...
      : animal === 'wolf'
      ? '강한 카리스마와 직관력으로 상대방의 진심을 꿰뚫어보는 늑대예요. 신뢰할 수 있는 파트너가 되어줍니다.'
      : animal === 'tiger'
      ? '타고난 리더십으로 팀을 이끌고 신뢰를 쌓아가는 호랑이예요. 함께하면 더 큰 시너지를 만들어냅니다.'
      : '전설적인 케미의 소유자예요. 뛰어난 통찰력과 매력으로 모든 이의 마음을 사로잡고 최고의 팀워크를 만들어냅니다.';
