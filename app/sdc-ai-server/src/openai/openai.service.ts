...
export class OpenAIService {
  ...
  private formatPrompt(promptData: Array<PromptData>): string {
    ...
    return `json을 참고하여 다음 지시사항에 따라 자기소개 글을 작성해주세요. 전체적으로 기술적 역량과 사회적 가치 추구, 그리고 협업 경험을 자연스럽게 융합하는 스토리텔링 방식으로 구성하세요:
...
2. 의미 있는 경험과 배움:
   ...
   - 봉사 활동이나 사회적 기여를 통해 얻은 인사이트
   - 이러한 경험이 현재 직업이나 관점에 미친 영향

3. 워라밸과 다양한 관심사:
   - 기술 외에 탐구하는 취미나 관심사
   - 이러한 활동들이 기술적 사고나 창의성에 미치는 영향

4. 구체적인 목표와 사회적 비전:
   - 기술을 통해 이루고자 하는 구체적인 사회적 목표
   - 커뮤니티나 오픈소스에 기여하고 싶은 부분
   - 특별히 관심 있는 기술적 문제나 해결하고 싶은 이슈
