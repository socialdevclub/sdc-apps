...
const cards: { name: string; description: string; status: ProjectStatus; url: string }[] = [
  {
    ...
    name: '주식 게임',
    status: 'OPEN',
    url: '/assets/img/GameImageStock.png',
  },
  {
    description: `한 번의 터치로 순식간에 퍼지는 좀비 바이러스!\n끝없이 번지는 바이러스 속에서 마지막까지\n 인간성을 지켜낼 사람은 과연 누구?!`,
    name: '좀비게임',
    status: 'COMING_SOON',
    url: '/assets/img/GameImageZombies.png',
  },
  {
    description: '소셜데브클럽의 시그니처 게임!\n커뮤니티에 기여하고 함께 성장해요',
    name: '마피아시즈',
    status: 'IN_DEVELOPMENT',
    url: '/assets/img/GameImageMafia.png',
  },
  {
    description: '추리하고, 의심해라!\n치밀한 판단력과 심리전으로 사건의 진실을\n쟁탈하는 미스터리 게임',
    name: '미스터리 크레딧',
    status: 'IN_DEVELOPMENT',
    url: '/assets/img/GameImageMysteryCredits.png',
  },
  {
    description:
    ...
    name: '챗몽어스',
    status: 'IN_DEVELOPMENT',
    url: '/assets/img/GameImageChat.png',
  },
  {
    description:
    ...
    name: '대항해',
    status: 'IN_DEVELOPMENT',
    url: '/assets/img/GameImageDiscovery.png',
  },
];
